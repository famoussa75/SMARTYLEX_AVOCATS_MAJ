<!-- Parties -->
<input type="hidden" value="FormCassation" name="formulaire" />
            ...
            <div id="dynamicAddRemove">
                <div class="form mt-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button type="button" name="add" id="dynamic-ar" onclick="addformCassation()"
                    ...
                    <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                        ...
                        <div class="row col-md-12" id="choixPartie-0">
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-0" name="formset[0][role]" onclick="var id=0; roleASKa(id)"
                                            value="Demandeur au pourvoi" type="radio" class="custom-control-input"
                                            required>
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKa-0">Demandeur au
                                            pourvoi</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-0" name="formset[0][role]" onclick="var id=0; roleASKb(id)"
                                            value="Defendeur au pourvoi" type="radio" class="custom-control-input">
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKb-0">Defendeur au
                                            pourvoi</span>
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKc-0" name="formset[0][role]" type="radio"
                                            class="custom-control-input" value="Autre" onclick="var id=0; roleASKc(id)">
                                        <span class="custom-control-indicator"></span>
                        ...
                        <div class="row cacher" style="margin-top: 20px;" id="personneExterne-0" hidden>
                            ...
                            <div class="row col-md-12 mb-4">
                                <div class="col-md-6">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            <input id="typeAdverse1-0" name="formset[0][typeAdverse]"
                                ...
                                <div class="col-md-6">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            <input id="typeAdverse2-0" name="formset[0][typeAdverse]" type="radio"
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="prenom" class="control-label">Prénom
                                            :</label>
                                        <input type="text" class="form-control" id="prenom-0"
                                            data-error=" veillez saisir prénom de la personne"
                                            name="formset[0][prenom]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nom-0"
                                            data-error=" veillez saisir le nom de la personne" name="formset[0][nom]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="profession" class="control-label">Telephone
                                            :</label>
                                        <input type="text" class="form-control" id="telephone-0"
                                            data-error=" veillez saisir un numero" name="formset[0][telephone]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="profession" class="control-label">Profession
                                            :</label>
                                        <input type="text" class="form-control" id="profession-0"
                                            data-error=" veillez saisir la profession" name="formset[0][profession]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="nationalite" class="control-label">Nationalité
                                            :</label>
                                        <input type="text" class="form-control" id="nationalite-0"
                                            data-error=" veillez saisir la nationalité" name="formset[0][nationalite]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="dateNaissance" class="control-label">Date de
                                            naissance
                                            :</label>
                                        <input type="date" class="form-control" id="dateNaissance-0"
                                            data-error=" veillez saisir la date de naissance de la personne"
                                            name="formset[0][dateNaissance]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="lNaissance" class="control-label">Lieu de
                                            naissance
                                            :</label>
                                        <input type="text" class="form-control" id="lNaissance-0"
                                            data-error=" veillez indiquer le Lieu de naissance"
                                            name="formset[0][lieuNaissance]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pays-0"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="domicile" class="control-label">domicile
                                            :</label>
                                        <input type="text" class="form-control" id="domicil-0"
                                            data-error=" veillez renseigner le domicile de la personne"
                                            name="formset[0][domicile]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="denomination" class="control-label">Dénomination
                                            :</label>
                                        <input type="text" class="form-control" id="denomination-0"
                                            data-error=" veillez saisir la dénomination de l'entreprise"
                                            name="formset[0][denomination]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="rccm" class="control-label">N° RCCM
                                            :</label>
                                        <input type="text" class="form-control" id="rccm-0"
                                            data-error=" veillez saisir le N° RCCM" name="formset[0][numRccm]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="siege" class="control-label">Siège Social
                                            :</label>
                                        <input type="text" class="form-control" id="siege-0"
                                            data-error=" veillez saisir le siège social de l'entreprise"
                                            name="formset[0][siegeSocial]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="formeLegal" class="control-label">Forme
                                            légale
                                            :</label>
                                        <input type="text" class="form-control" id="formeLegal-0"
                                            data-error=" veillez saisir la forme légale" name="formset[0][formeLegal]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="representantLegal" class="control-label">Répresentant
                                            légal
                                            :</label>
                                        <input type="text" class="form-control" id="representantLegal-0"
                                            data-error=" veillez saisir le nom du répresentant légal"
                                            name="formset[0][representantLegal]">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
...
<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingFour">
        <h4 class="panel-title">
            <a class="collapsed" role="button" data-toggle="collapse" onclick="LoadSelect2Script(oSelectForm);"
        ...
        <div class="panel-body">
            ...
            <!-- <div class="col-md-12 mrg-0" id="matiere">
                ...
                <div class="form-group">
                    ...
                    <select name="idNatureAction" id="" class="form-select select2" style="width:100%"
                        data-placeholder="Choisissez..." required>
                        <option value="" selected disabled>-- Choisissez --</option>
                        @foreach($natureActions as $n)
                        <option value={{$n->idNatureAction}}>{{$n->natureAction}} | délais: {{$n->delaiAction}} |
            ...
            <input id="" name="typeActe" type="hidden" class="custom-control-input" value="Pourvoi">
            ...
            <div class="row col-md-12">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" data-error=" veillez remplir ce champ"
                            name="numPourvoi">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="control-label">N° décision<span style="color:red">*</span> :</label>
                        <input type="text" class="form-control" id="" data-error=" veillez remplir ce champ"
                            name="numDecisConcerner" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="control-label">Date pourvoi<span style="color:red">*</span> :</label>
                        <input type="date" class="form-control" id="" data-error="veillez remplir ce champ"
                            name="datePourvoi" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="control-label">Date de la décision<span style="color:red">*</span> :</label>
                        <input type="date" class="form-control" id="" data-error="veillez remplir ce champ"
                            name="dateDecision" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
