            ...
            <div id="dynamicAddRemove">
                <div class="form mt-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button type="button" name="add" id="dynamic-ar" onclick="addformAppel()" class="cl-white theme-bg btn btn-rounded" style="float:right"><i class="fa fa-plus"></i></button>
                        </div>
                    ...
                    <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                        ...
                        <div class="row col-md-12" id="choixPartie-0">
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-0" name="formset[0][role]" onclick="var id=0; roleASKa(id)" value="Appelant" type="radio" class="custom-control-input" required>
                            ...
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-0" name="formset[0][role]" onclick="var id=0; roleASKb(id)" value="Intimé(e)" type="radio" class="custom-control-input" >
                                        <span class="custom-control-indicator"></span>
...
<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingFour" style="background-color:whitesmoke; ">
        <h4 class="panel-title">
        ...
        <div class="panel-body">
            ...
            <div class="row mb-5" style="border: 1px solid; padding:10px;border-radius: 5px;">
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="requisitoire" name="typeActe" onclick="formAssignationAppel()" type="radio" class="custom-control-input" value="Assignation" required>
                            <span class="custom-control-indicator"></span>
                ...
                <!-- <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="" name="typeActe" onclick="formRequeteAppel()" type="radio" class="custom-control-input" value="Requete" >
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="assignation" name="typeActe" onclick="formDeclarationAppel()" type="radio" class="custom-control-input" value="Declaration d'appel" >
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="" name="typeActe" onclick="formContredit()" type="radio" class="custom-control-input" value="Contredit" >
                            <span class="custom-control-indicator"></span>
                ...
                <div class="row col-md-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRG"  data-error="veillez remplir ce champ" name="numRgDeclaration" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numJugement"  data-error="veillez remplir ce champ" name="numJugement" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateAppel"  data-error=" veillez remplir ce champ" name="dateAppel" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                ...
                <div class="row col-md-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numConcerner"  data-error="veillez remplir ce champ" name="numConcerner" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numDecision"  data-error="veillez remplir ce champ" name="numDecisConcerner" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateContredit" data-error="veillez remplir ce champ" name="dateContredit" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateDecision" data-error="veillez remplir ce champ" name="dateDecision" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row col-md-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRgAss" data-error=" veillez saisir le N° RG" name="numRg" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="mentionP" class="control-label">Mention particulière
                                :</label>
                            <textarea id="mentionParticuliere" cols="4" rows="2" class="form-control" data-error=" veillez saisir la mention particulière" name="mentionParticuliere" ></textarea>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRgRequete"  data-error=" veillez saisir la date" name="numRgRequete" >
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
