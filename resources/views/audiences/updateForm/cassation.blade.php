                        ...
                        <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                            ...
                            <div class="row col-md-12" id="choixPartie-0">
                                <div class="col-md-4">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            <input id="roleASKa-0" name="formset[0][role]" onclick="var id=0; roleASKa(id)" value="Demandeur au pourvoi" type="radio" class="custom-control-input" required @if($partiesCabinet[0]->role=='Demandeur au pourvoi') checked @else disabled @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            <input id="roleASKb-0" name="formset[0][role]" onclick="var id=0; roleASKb(id)" value="Defendeur au pourvoi" type="radio" class="custom-control-input" @if($partiesCabinet[0]->role=='Defendeur au pourvoi') checked @else disabled @endif>
                                            <span class="custom-control-indicator"></span>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-1" name="formset[{{ $loop->iteration }}][role]"
                                            ...
                                            @if($p->role=='Demandeur au pourvoi') checked @else disabled @endif >
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-1" name="formset[{{ $loop->iteration }}][role]"
                                            ...
                                            @if($p->role=='Defendeur au pourvoi') checked @else disabled @endif>
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKb-0">Defendeur au pourvoi</span>
                                    </label>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" data-error=" veillez remplir ce champ"
                            name="numPourvoi" value="{{$acteDetail[0]->numPourvoi}}">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" data-error=" veillez remplir ce champ"
                            name="numDecisConcerner" required value="{{$acteDetail[0]->numDecision}}">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="" data-error="veillez remplir ce champ"
                            name="datePourvoi" required value="{{$acteDetail[0]->datePourvoi}}">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="" data-error="veillez remplir ce champ"
                            name="dateDecision" required value="{{$acteDetail[0]->dateDecision}}">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
