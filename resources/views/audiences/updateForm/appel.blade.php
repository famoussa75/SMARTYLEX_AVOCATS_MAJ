                    ...
                    <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                        ...
                        <div class="row col-md-12" id="choixPartie-0">
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-0" name="formset[0][role]" onclick="var id=0; roleASKa(id)" value="Appelant" type="radio" class="custom-control-input" required @if($partiesCabinet[0]->role=='Appelant(e)') checked @else disabled @endif>
                            ...
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-0" name="formset[0][role]" onclick="var id=0; roleASKb(id)" value="Intimé(e)" type="radio" class="custom-control-input" @if($partiesCabinet[0]->role=='Intimé(e)') checked @else disabled @endif>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-1" name="formset[{{ $loop->iteration }}][role]"
                                            ...
                                            @if($p->role=='Appelant(e)') checked @else disabled @endif >
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKa-0">Appelant(e)</span>
                                    </label>
                                </div>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-1" name="formset[{{ $loop->iteration }}][role]"
                                            ...
                                            @if($p->role=='Intimé(e)') checked @else disabled @endif>
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKb-0">Intimé(e)</span>
                                    </label>
                                </div>
        ...
        <div class="panel-body">
            ...
            <div class="row mb-5" style="border: 1px solid; padding:10px;border-radius: 5px;">
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="requisitoire" name="typeActe" onclick="" type="radio" class="custom-control-input" value="Assignation" required  @if($actes[0]->typeActe=='Assignation') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="" name="typeActe" onclick="" type="radio" class="custom-control-input" value="Requete"  @if($actes[0]->typeActe=='Requete') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="assignation" name="typeActe" onclick="" type="radio" class="custom-control-input" value="Declaration d'appel" @if($actes[0]->typeActe=="Declaration d'appel") checked @else disabled @endif >
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="" name="typeActe" onclick="" type="radio" class="custom-control-input" value="Contredit"  @if($actes[0]->typeActe=='Contredit') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
             ...
             @if($actes[0]->typeActe=="Declaration d'appel")
            <div class="row mrg-0" id="formDeclarationAppel"  @if($actes[0]->typeActe=="Declaration d'appel") @else hidden @endif>
                ...
                <div class="row col-md-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRG"  data-error="veillez remplir ce champ" name="numRgDeclaration" value="{{$acteDetail[0]->numRg}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numJugement"  data-error="veillez remplir ce champ" name="numJugement" value="{{$acteDetail[0]->numJugement}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateAppel"  data-error=" veillez remplir ce champ" name="dateAppel" value="{{$acteDetail[0]->dateAppel}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
            ...
            @endif
             ...
             @if($actes[0]->typeActe=="Contredit")
            <div class="row mrg-0" id="formContredit" @if($actes[0]->typeActe=="Contredit") @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                    <h2>Contredit</h2>
                    <hr>
                </div>
                <div class="row col-md-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numConcerner"  data-error="veillez remplir ce champ" name="numConcerner" value="{{$acteDetail[0]->numConcerner}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numDecision"  data-error="veillez remplir ce champ" name="numDecisConcerner" value="{{$acteDetail[0]->numDecisConcerner}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateContredit" data-error="veillez remplir ce champ" name="dateContredit" value="{{$acteDetail[0]->dateContredit}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateDecision" data-error="veillez remplir ce champ" name="dateDecision" value="{{$acteDetail[0]->dateDecision}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mrg-0" id="formAssignationAppel" @if($actes[0]->typeActe=="Assignation") @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                    <h2>Assignation</h2>
                    <hr>
                </div>
                <div class="row col-md-12">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRgAss" data-error=" veillez saisir le N° RG" name="numRg" value="{{$acteDetail[0]->numRg}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-placeholder="Rechercher..." style="width: 100%;" name="idHuissier" id="huissier" >
                                 <option value={{$acteDetail[0]->idHuissier}} selected disabled>{{ $acteDetail[0]->prenomHss }} {{ $acteDetail[0]->nomHss }}</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            data-error=" veillez saisir le nom du receveur" name="recepteurAss" value="{{$acteDetail[0]->recepteurAss}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" onchange="validateDatesAss()" class="form-control" id="dateAssignation"  data-error=" veillez saisir la date asignation" name="dateAssignation" value="{{$acteDetail[0]->dateAssignation}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" onchange="validateDatesAss()" class="form-control" id="dateEnrollement" data-error=" veillez saisir la date d'enroulement" name="dateEnrollement" value="{{$acteDetail[0]->dateEnrollement}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="inputFDAT" class="control-label">Date de la 1ère comparution
                                :</label>
                            <input type="date" onchange="validateDatesAss()" class="form-control" id="datePremiereComp"  data-error=" veillez saisir la Date de la première comparution" name="datePremiereComp" value="{{$acteDetail[0]->datePremiereComp}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="mentionP" class="control-label">Mention particulière
                                :</label>
                            <textarea id="mentionParticuliere" cols="4" rows="2" class="form-control" data-error=" veillez saisir la mention particulière" name="mentionParticuliere" >{{$acteDetail[0]->mentionParticuliere}}</textarea>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
            ...
            <div class="row mrg-0" id="formRequeteAppel" @if($actes[0]->typeActe=="Requete") @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                    <h2>Requete</h2>
                    <hr>
                </div>
                <div class="row col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRgRequete"  data-error=" veillez saisir la date" name="numRgRequete" value="{{$acteDetail[0]->numRg}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateRequete"  data-error=" veillez saisir la date" name="dateRequete" value="{{$acteDetail[0]->dateRequete}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateArriver"  data-error=" veillez saisir la date" name="dateArriver" value="{{$acteDetail[0]->dateArriver}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="juriductionPresidentielle"  data-error=" veillez remplir ce champ" name="juriductionPresidentielle" value="{{$acteDetail[0]->juriductionPresidentielle}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
