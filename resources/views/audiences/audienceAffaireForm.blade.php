    ...
    <div class="row page-breadcrumbs">
        ...
        <div class="col-md-7 text-right">
            <div class="btn-group mr-lg-2">
                <a  href="{{ route('allClient') }}" class="cl-white theme-bg btn  btn-rounded">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="client" class="control-label">Selectionner le client
                                                    :</label>
                                                <select name="idClient" id="client" class="form-control" data-placeholder="Selectionner le client" required>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="affaireClient" class="control-label">Affaire du client
                                                    concernés :</label>
                                                <select class="form-control" data-placeholder="Affaire du client concerné" style="width: 100%;" name="idAffaire" required>
                                    ...
                                    <div class="row mrg-0">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control custom-radio">
                                                    <input id="typeAdverse1" name="typeAdverse" type="radio" class="custom-control-input" value="Personne physique" checked>
                                                    <span class="custom-control-indicator"></span>
                                    ...
                                    <div class="row mrg-0" id="adversePersonne">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="domicilee" class="control-label">domicilee :</label>
                                                <input type="text" class="form-control" id="domicile" placeholder="domicilee " data-error=" veillez renseigner le domicilee de la personne" name="domicile" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mrg-0">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="inputRG" placeholder="N° du registre général" data-error=" veillez saisir le N° RG" name="numRg">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="inpuRC" class="control-label">Réçu par :</label>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="inputFDAT" class="control-label">Date de la 1ère comparution
                                                    :</label>
                                                <input type="date" class="form-control" id="inputFDAT" placeholder="Date de la première comparution " data-error=" veillez saisir la Date de la première comparution" name="datePremiereComp" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
