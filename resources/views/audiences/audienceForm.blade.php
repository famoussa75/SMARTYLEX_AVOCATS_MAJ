...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <form  method="post" action="{{route('storeAudience')}}" enctype="multipart/form-data">
            @csrf
                <div class="card padd-10">
                    <div class="panel-group accordion-stylist" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                <div class="panel-body">
                                    <div class="row mrg-0">
                                        ...
                                        <div class="col-md-12 col-sm-12" id="orientationProcedurale">
                                            ...
                                            <div class="custom-controls-stacked">
                                                <label class="custom-control custom-radio">
                                                    <input id="radioStackedPro1" name="orientationProcedure" type="radio" class="custom-control-input">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description">Fond</span>
                                                </label>
                                                <label class="custom-control custom-radio">
                                                    <input id="radioStackedPro2" name="orientationProcedure" type="radio" class="custom-control-input">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description">Référé</span>
                                                </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-12" id="divTypeRequete" hidden>
                                                <div class="form-group">
                                                    ...
                                                    <select name="typeRequete" id="typeRequete" class="form-select select2" style="width:100%" >
                                                        ...
                                                        <option value="Requête aux fins de prorogation du délai de la tenue de l'AGO">Requête aux fins de prorogation du délai de la tenue de l'AGO</option>
                                                        <option value="Requête aux fins d'homologation d'un protocole d'accord">Requête aux fins d'homologation d'un protocole d'accord</option>
                                                        <option value="Requête aux fins d'être autorisé à assigner en référé">Requête aux fins d'être autorisé à assigner en référé</option>
                                                        <option value="Requête aux fins d'être autorisé à assigner à jour fixe">Requête aux fins d'être autorisé à assigner à jour fixe</option>
                                                        <option value="Requête aux fins d'injonction de payer">Requête aux fins d'injonction de payer</option>
                                                        <option value="Requête aux fins d'injonction de restituer ou de délivrer">Requête aux fins d'injonction de restituer ou de délivrer</option>
                                                        <option value="Requête aux fins d'injonction de faire">Requête aux fins d'injonction de faire</option>
                                                        <option value="Requête aux fins d'être autorisé à assigner en référé d'heure à heure">Requête aux fins d'être autorisé à assigner en référé d'heure à heure</option>
                                        ...
                                        <div class="col-md-4 cacher" id="clientProcedure-req" hidden>

                                            <div class="form-group">
                                                <label for="affaire" class="control-label">Procédure(s) sur requête
                                                    concernée(s)*
                                                    :</label>
                                                <select multiple class="form-control select2" data-placeholder="" style="width: 100%;height:28px" name="requeteLier[]" id="requeteClient" >
                        ...
                        <div class="panel panel-default" id="divNiveauProcedural" hidden>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="nature" id="nature" class="form-select select2" style="width:100%" onchange="natureAud();" >
                                                    <option value="" selected disabled>-- Choisissez --</option>
                                                    <option value="Civile">Civile, Commerciale, Administrative, Sociale</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="row" style="background-color: white;padding-top:10px;padding-left:15px;">
                                    <div class="form-group has-warning">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="pieceDispo" class="pieceDispo" id="pieceDispo" onchange="disponibilitePiece()">
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Pièces non disponibles</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" id="autrePieces">
                            <label for="">Importez les pièces par ordre</label>
                            <div class="row mrg-0">
                                <table class="table table-bordered" id="dynamicAddRemovePiece">
                                    <tr>
...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('submitButton').addEventListener('click', function (e) {
        e.preventDefault(); // bloquer soumission automatique
        ...
        // 2. vérification du nombre de parties selon le type de procédure
        const parties = document.querySelectorAll('.form');
        const typeProcedure = (document.getElementById('selectTypeProcedure')?.value || '').trim();
        ...
        if (typeProcedure === 'contentieux' && parties.length < 2) {
            ...
            Swal.fire({
                title: 'Attention !',
                text: "Il n'y a qu'une seule PARTIE. Voulez-vous continuer quand même ?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function addformPIC() {
        ...
        $("#dynamicAddRemove").append(`
            ...
            i + `;otherSelect(id)"
                                ...
                                <option value='pc'>Prévenu(e)/ Accusé(e)</option>
    ...
    // Formset pour la requete
    function addformRequete() {
                    ...
                    <div class="col-md-4">
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input id="roleASKa-` + i + `" name="formset[` + i + `][role]"
                                    type="radio" class="custom-control-input" onclick="var id=` + i + `; roleASKa(id)"
                                    value="Requérant(e)" required>
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">Requérant(e) </span>
                            </label>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input id="roleASKb-` + i + `" name="formset[` + i + `][role]"
                                    ...
                                    value="Requis(e)" >
                                <span class="custom-control-indicator"></span>
                                <span class="custom-control-description">Requis(e)</span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-4">
    ...
    function validateDatesOpp() {
            ...
            if (datePremiereCompOpp <= dateEnrollementOpp || dateEnrollementOpp < dateActe) {
                ...
                document.getElementById('dateProchaineAud').value=document.getElementById('datePremiereCompOpp').value;
                $('#submitButton').prop('disabled', false);
                $('#submitButton').removeClass('btn-default');
                $('#submitButton').addClass('theme-bg');
            }
