        ...
        <div class="panel-body">
            <div id="dynamicAddRemove">
                    ...
                    <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                        ...
                        <div class="row col-md-12" id="choixPartie-0">
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-0" name="formsetCabinet[{{ $loop->iteration }}][role]"
                                            value="Demandeur" type="radio" class="custom-control-input" required
                                            @if($c->role=='Demandeur') checked @else
                                        @endif>
                            ...
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-0" name="formsetCabinet[{{ $loop->iteration }}][role]"
                            ...
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKc-0" name="formsetCabinet[{{ $loop->iteration }}][role]"
                                            type="radio" class="custom-control-input" value="Autre"
                                            @if($c->role=='Autre') checked @else disabled
                                        @endif>
                                        <span class="custom-control-indicator"></span>
                        ...
                        <div class="row" style="margin-top: 20px;">
                            <div class="col-md-3 toReload" id="other-0" @if($c->role=='Autre') @else
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="formsetCabinet[{{ $loop->iteration }}][autreRole]" id="otherSelect-0"
                            ...
                            <div class="col-md-3 cacher" id="avc-0">
                                <div class="form-group" id="dropSelect-0">
                                    ...
                                    <select name="formsetCabinet[{{ $loop->iteration }}][typeAvocat]" id="typeAvocat-0"
                            ...
                            <div class="col-md-4 cacher" id="clientContent-0" @if($c->typeAvocat==1)
                                ...
                                <div class="form-group">
                                    <label for="client" class="control-label">Selectionner le
                                        client*
                                        :</label>
                                    <select name="formsetCabinet[{{ $loop->iteration }}][idClient]" id="client-0"
                            ...
                            <div class="col-md-5 cacher" id="affaireContent-0" @if($c->typeAvocat==1)
                                @else hidden @endif>
                                <input type="text" id="typeContent-0" value="audience"
                                    name="formsetCabinet[{{ $loop->iteration }}][typeContent]" hidden>
                            ...
                            <div class="col-md-6 cacher" id="otherAvocats-0" @if($c->role!='Autre')
                                ...
                                <div class="form-group">
                                    ...
                                    <select multiple name="formsetCabinet[{{ $loop->iteration }}][idAvocat][]"
                ...
                <div class="form mt-4">
                    <div class="mt-4 row">
                        <div class="col-md-6">
                            <h3>PARTIE <span
                                    class="iterationPartie">{{ $loop->iteration+count($partiesCabinet) }}</span></h3>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-1" name="formset[{{ $loop->iteration }}][role]"
                                            value="Demandeur" type="radio" class="custom-control-input" required
                                            @if($p->role=='Demandeur') checked @else @endif >
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKa-0">Demandeur</span>
                                    </label>
                                </div>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-1" name="formset[{{ $loop->iteration }}][role]"
                                            value="Defendeur" type="radio" class="custom-control-input"
                                            @if($p->role=='Defendeur') checked @else @endif>
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKb-0">Defendeur</span>
                                    </label>
                                </div>
            ...
            <div class="col-md-6 mt-4 mb-4">
                <button type="button" name="add" id="dynamic-update" onclick="addformPIC()"
                    class="cl-white theme-bg btn btn-rounded" style="float:right"><i class="fa fa-plus"></i></button>
            </div>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row mb-5 " style="border: 1px solid; padding:10px;border-radius: 5px;" hidden>
                ...
                <div class="col-md-3" id="assignationCheckbox">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="assignation" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="formAssignation()" type="radio"
                                class="custom-control-input" value="Assignation" required
                                @if($a->typeActe=='Assignation') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="requeteCheckbox">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="requete" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="formRequete()" type="radio"
                                class="custom-control-input" value="Requete" @if($a->typeActe=='Requete') checked
                            @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-6" id="requisitoireCheckbox">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="requisitoire" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="formOpposition()" type="radio"
                                class="custom-control-input" value="Opposition" @if($a->typeActe=='Opposition')
            ...
            <div class="row mrg-0" id="formAssignation" @if($a->typeActe=='Assignation') @else hidden @endif>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="numRg" data-error=" veillez saisir le N° RG"
                                name="formsetActe[{{ $loop->iteration }}][numRg]" value="{{$ad->numRg}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-placeholder="Rechercher..." style="width: 100%;"
                                name="formsetActe[{{ $loop->iteration }}][idHuissier]" id="huissierAssign">
                                <option value={{$ad->idHuissier}} selected>{{$ad->prenomHss}}
                                    {{$ad->nomHss}}</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recepteurAss"
                                data-error=" veillez saisir le nom du receveur" name="formsetActe[{{ $loop->iteration }}][recepteurAss]"
                                value="{{$ad->recepteurAss}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" onchange="validateDatesAss()" class="form-control" id="dateAssignation"
                                data-error=" veillez saisir la date asignation" name="formsetActe[{{ $loop->iteration }}][dateAssignation]"
                                value="{{$ad->dateAssignation}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" onchange="validateDatesAss()" class="form-control" id="dateEnrollement"
                                data-error=" veillez saisir la date d'enroulement" name="formsetActe[{{ $loop->iteration }}][dateEnrollement]"
                                value="{{$ad->dateEnrollement}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" onchange="validateDatesAss()" class="form-control" id="datePremiereComp"
                                data-error=" veillez saisir la Date de la première comparution" name="formsetActe[{{ $loop->iteration }}][datePremiereComp]"
                                value="{{$ad->datePremiereComp}}">
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea id="mentionParticuliereAssign" cols="4" rows="2" class="form-control"
                                ...
                                name="formsetActe[{{ $loop->iteration }}][mentionParticuliere]">{{$ad->mentionParticuliere}}</textarea>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
                    @endif
            ...
            <div class="row mrg-0" id="formRequete" @if($a->typeActe=='Requete') @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="numRgRequete"
                                    data-error=" veillez saisir le mumero RG" name="formsetActe[{{ $loop->iteration }}][numRgRequete]"
                                    value="{{$ad->numRg}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dateRequete"
                                    data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][dateRequete]"
                                    value="{{$ad->dateRequete}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dateArriver"
                                    data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][dateArriver]"
                                    value="{{$ad->dateArriver}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="juriductionPresidentielle"
                                    data-error=" veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][juriductionPresidentielle]"
                                    value="{{$ad->juriductionPresidentielle}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <!-- <div class="col-sm-6">
            ...
            @if($a->typeActe=='Opposition')
            <div class="row mrg-0" id="formOpposition" @if($a->typeActe=='Opposition') @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                    <h2>Opposition / Tierce Opposition#{{$loop->iteration}}</h2>
                    <hr>
                </div>
                @foreach($acteDetail as $ad)
                    @if($ad->idActe==$a->idActe)
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="numRgOpp" data-error=" veillez saisir le N° RG"
                                    name="formsetActe[{{ $loop->iteration }}][numRgOpp]" value="{{$ad->numRg}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" data-placeholder="Rechercher..." style="width: 100%;"
                                    name="formsetActe[{{ $loop->iteration }}][idHuissierOpp]" id="idHuissierOpp">
                                    <option value={{$ad->idHuissier}} selected>{{$ad->prenomHss}}
                                        {{$ad->nomHss}}</option>
                                    @foreach ($huissiers as $h)
                                    <option value={{ $h->idHss }}>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="recepteurAssOpp"
                                    data-error=" veillez saisir le nom du receveur" name="formsetActe[{{ $loop->iteration }}][recepteurAssOpp]"
                                    value="{{$ad->recepteurAss}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" onchange="validateDatesOpp()" id="dateActe"
                                    data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][dateActe]"
                                    value="{{$ad->dateActe}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" onchange="validateDatesOpp()"
                                    ...
                                    name="formsetActe[{{ $loop->iteration }}][dateEnrollementOpp]" value="{{$ad->dateEnrollement}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" onchange="validateDatesOpp()"
                                    ...
                                    name="formsetActe[{{ $loop->iteration }}][datePremiereCompOpp]" value="{{$ad->datePremiereComp}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dateProchaineAud"
                                    data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][dateProchaineAud]"
                                    value="{{$ad->dateProchaineAud}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="numDecision" data-error=" veillez saisir le N°"
                                    name="formsetActe[{{ $loop->iteration }}][numDecisConcerner]" value="{{$ad->numDecision}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="mentionParticuliereOpp" cols="4" rows="2" class="form-control"
                                    data-error=" veillez saisir la mention particulière"
                                    name="formsetActe[{{ $loop->iteration }}][mentionParticuliereOpp]">{{$ad->mentionParticuliere}}</textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <!-- <div class="col-sm-6">
