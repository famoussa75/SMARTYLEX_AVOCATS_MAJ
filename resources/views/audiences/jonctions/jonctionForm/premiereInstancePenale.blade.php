                    ...
                    <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                        ...
                        <div class="row col-md-12" id="choixPartie-0">
                            ...
                            <div class="col-md-4">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-0" name="formsetCabinet[{{ $loop->iteration }}][role]" onclick="var id=0; roleASKb(id)" value="Partie civile" type="radio" class="custom-control-input"  @if($c->role=='Partie civile')
                                        checked @else  @endif>
                                        <span class="custom-control-indicator"></span>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-1" name="formset[{{ $loop->iteration }}][role]"
                                            ...
                                            @if($p->role=='Partie civile') checked @else  @endif>
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKb-0">Partie civile</span>
                                    </label>
                                </div>
         ...
         <div class="panel-body">
            ...
            <div class="row mb-5" style="border: 1px solid; padding:10px;border-radius: 5px;" hidden>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="assignation" name="typeActe" onclick="" type="radio" class="custom-control-input" value="PV introgatoire"  @if($a->typeActe=='PV introgatoire') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-2" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="requete" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="" type="radio" class="custom-control-input" value="Requisitoire"  @if($a->typeActe=='Requisitoire') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-3" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="requisitoire" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="" type="radio" class="custom-control-input" value="Ordonnance Renvoi" @if($a->typeActe=='Ordonnance Renvoi') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-2" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="ordonnance" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="" type="radio" class="custom-control-input" value="Citation directe" @if($a->typeActe=='Citation directe') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
                ...
                <div class="col-md-2" id="">
                    <div class="custom-controls-stacked">
                        <label class="custom-control custom-radio">
                            <input id="ordonnance" name="formsetActe[{{ $loop->iteration }}][typeActe]" onclick="" type="radio" class="custom-control-input" value="PCPC"  @if($a->typeActe=='PCPC') checked @else disabled @endif>
                            <span class="custom-control-indicator"></span>
            ...
            @if($a->typeActe=='PV introgatoire')
                <div class="row mrg-0" id="formPvInterogatoire" @if($a->typeActe=='PV introgatoire') @else hidden @endif>
                    <div class="col-md-12" style="text-align:center ;">
                        <h2>Pv introgatoire#{{$loop->iteration}}</h2>
                        <hr>
                    </div>
                        ...
                        <div class="row col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dateAudition"  data-error=" veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][dateAudition]" value="{{$ad->dateAudition}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id=""  data-error="veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][identiteOPJ]" value="{{$ad->identiteOPJ}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="infractions"  data-error="veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][infractions]" value="{{$ad->infractions}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dateAudience"  data-error=" veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][dateAudience]" value="{{$ad->dateAudience}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                        </div>
            ...
            @if($a->typeActe=='Requisitoire')
            <div class="row mrg-0" id="formRequisitoire" @if($a->typeActe=='Requisitoire') @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                    <h2>Requisitoire#{{$loop->iteration}}</h2>
                    <hr>
                </div>
                @foreach($acteDetail as $ad)
                    @if($ad->idActe==$a->idActe)
                    <div class="row col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id=""  data-error=" veillez saisir le N°" name="formsetActe[{{ $loop->iteration }}][numInstruction]" value="{{$ad->numInstruction}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id=""  data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][procureur]" value="{{$ad->procureur}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="formsetActe[{{ $loop->iteration }}][chefAccusationReq]" class="form-control" id="chefAccusationReq" cols="30" rows="10" >{{$ad->chefAccusation}}</textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
            ...
            @if($a->typeActe=='Ordonnance Renvoi')          
                <div class="row mrg-0" id="formOrdonnanceRenvoi" @if($a->typeActe=='Ordonnance Renvoi') @else hidden @endif>
                    <div class="col-md-12" style="text-align:center ;">
                        <h2>Ordonnance Renvoi#{{$loop->iteration}}</h2>
                        <hr>
                    </div>
                    @foreach($acteDetail as $ad)
                        @if($ad->idActe==$a->idActe)
                        <div class="row col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="numOrd"  data-error=" veillez saisir le N°" name="formsetActe[{{ $loop->iteration }}][numOrd]" value="{{$ad->numOrd}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cabinetIns"  data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][cabinetIns]" value="{{$ad->cabinetIns}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="formsetActe[{{ $loop->iteration }}][typeProcedure]" id="typeProcedure" class="form-select select2" style="width:100%" >
                                        <option value="{{$ad->typeProcedure}}" selected>{{$ad->typeProcedure}}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inputPr" class="control-label">Chef d'accusation :</label>
                                    <textarea name="formsetActe[{{ $loop->iteration }}][chefAccusationOrd]" class="form-control" id="" cols="30" rows="10">{{$ad->chefAccusation}}</textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
            ...
            @if($a->typeActe=='Citation directe')
                <div class="row mrg-0" id="formCitationDirect" @if($a->typeActe=='Citation directe') @else hidden @endif>
                    <div class="col-md-12" style="text-align:center ;">
                        <h2>Citation directe#{{$loop->iteration}}</h2>
                        <hr>
                    </div>
                    @foreach($acteDetail as $ad)
                        @if($ad->idActe==$a->idActe)
                        <div class="row col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="formsetActe[{{ $loop->iteration }}][saisi]" id="idSaisiPar" class="form-select select2" style="width:100%" onchange="saisiPar()"  >
                                        <option value="{{$ad->saisi}}" selected >{{$ad->saisi}}</option>
                            ...
                            <div class="col-md-6" id="huissier">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" data-placeholder="Rechercher..." style="width: 100%;" name="formsetActe[{{ $loop->iteration }}][idHuissier]" >
                                    <option value={{$ad->idHuissier}} selected >{{ $ad->prenomHss }} {{ $ad->nomHss }}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="recepteurCitation"  data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][recepteurCitation]" value="{{$ad->recepteurCitation}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6" id="dateSignification">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id=""  data-error=" veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][dateSignification]" value="{{$ad->dateSignification}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id=""  data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][dateHeureAud]" value="{{$ad->dateHeureAud}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mentionParticuliere"  data-error=" veillez saisir la date" name="formsetActe[{{ $loop->iteration }}][mentionParticuliere]" value="{{$ad->mentionParticuliere}}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="inputPr" class="control-label">Chef d'accusation :</label>
                                    <textarea name="formsetActe[{{ $loop->iteration }}][chefAccusation]" class="form-control" id="chefAccusation" cols="30" rows="10" >{{$ad->chefAccusation}}</textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
            ...
            @if($a->typeActe=='PCPC')
            <div class="row mrg-0" id="formPcpc" @if($a->typeActe=='PCPC') @else hidden @endif>
                <div class="col-md-12" style="text-align:center ;">
                    <h2>Plainte avec Constitution de Partie Civile#{{$loop->iteration}}</h2>
                    <hr>
                </div>
                @foreach($acteDetail as $ad)
                    @if($ad->idActe==$a->idActe)
                    <div class="row col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="datePcpc"  data-error=" veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][datePcpc]" value="{{$ad->datePcpc}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="reference"  data-error="veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][reference]" value="{{$ad->reference}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dateProchaineAud"  data-error=" veillez remplir ce champ" name="formsetActe[{{ $loop->iteration }}][dateProchaineAud]" value="{{$ad->dateProchaineAud}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
