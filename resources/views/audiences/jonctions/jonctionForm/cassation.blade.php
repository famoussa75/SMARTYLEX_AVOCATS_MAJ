...
<div class="panel panel-default" id="partieInstance">
    ...
    <div id="collapseTwo" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingTwo">
                        ...
                        <div style="border: 1px solid; padding:10px;border-radius: 5px;">
                            ...
                            <div class="row col-md-12" id="choixPartie-0">
                                <div class="col-md-4">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            <input id="roleASKa-0" name="formsetCabinet[{{ $loop->iteration }}][role]" onclick="" value="Demandeur au pourvoi" type="radio" class="custom-control-input" required @if($c->role=='Demandeur au pourvoi') checked @else  @endif>
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description" id="labelroleASKa-0">Demandeur au pourvoi(e)</span>
                                        </label>
                                    </div>
                                </div>
                                <br>
                                <div class="col-md-4">
                                    <div class="custom-controls-stacked">
                                        <label class="custom-control custom-radio">
                                            <input id="roleASKb-0" name="formsetCabinet[{{ $loop->iteration }}][role]" onclick="" value="Defendeur au pourvoi" type="radio" class="custom-control-input" @if($c->role=='Defendeur au pourvoi') checked @else  @endif>
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description" id="labelroleASKb-0">Defendeur au pourvoi</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKa-1" name="formset[{{ $loop->iteration }}][role]"
                                            value="Demandeur au pourvoi" type="radio" class="custom-control-input" required
                                            @if($p->role=='Demandeur au pourvoi') checked @else  @endif >
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKa-0">Demandeur au pourvoi</span>
                                    </label>
                                </div>
                            </div>
                            <br>
                                ...
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio">
                                        <input id="roleASKb-1" name="formset[{{ $loop->iteration }}][role]"
                                            ...
                                            @if($p->role=='Defendeur au pourvoi') checked @else  @endif>
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description" id="labelroleASKb-0">Defendeur au pourvoi</span>
                                    </label>
                                </div>
        ...
        <div class="col-md-6 mt-4 mb-4">
            <button type="button" name="add" id="dynamic-a" onclick="addformCassation()" class="cl-white theme-bg btn btn-rounded" style="float:right"><i class="fa fa-plus"></i></button>
        </div>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingFour">
        <h4 class="panel-title">
            <a class="collapse" role="button" data-toggle="collapse" onclick="LoadSelect2Script(oSelectForm);"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="" data-error=" veillez remplir ce champ"
                                    name="formsetActe[{{ $loop->iteration }}][numPourvoi]" value="{{$ad->numPourvoi}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="" data-error=" veillez remplir ce champ"
                                    name="formsetActe[{{ $loop->iteration }}][numDecisConcerner]" required value="{{$ad->numDecision}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="" data-error="veillez remplir ce champ"
                                    name="formsetActe[{{ $loop->iteration }}][datePourvoi]" required value="{{$ad->datePourvoi}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="" data-error="veillez remplir ce champ"
                                    name="formsetActe[{{ $loop->iteration }}][dateDecision]" required value="{{$ad->dateDecision}}">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
...
<div class="form-group">
    ...
    <button type="submit" id="submitButton" class="theme-bg btn btn-rounded btn-block" style="width:50%;">
            Enregistrer</button>
    </div>
</div>