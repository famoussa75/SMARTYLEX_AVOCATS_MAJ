...
<div class="container-fluid">
    ...
    <div class="row page-breadcrumbs">
        <div class="col-md-5 align-self-center">
            <h4 class="theme-cl"><i class="ti-bag"></i> Affaires > <span class="label bg-info"><b>Liste des
                        affaires</b></span></h4>
        </div>
        ...
        <div class="col-md-7 text-right">
            ...
            <div class="btn-group">
                <a href="{{ route('createAffaire') }}" class="cl-white theme-bg btn  btn-rounded"
                    title="Creer une Affaire">
                    <i class="ti-wand"></i>
                    Creer une affaire
                </a>
            </div>
                ...
                <table id="filterTable" class="filterTable dataTableExport table table-bordered table-hover"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('showAffaire', [$row->idAffaire,$row->slug]) }}" class="settings"
                                    title="Information"><i class="fa fa-arrow-right"></i></a>
                            </td>
