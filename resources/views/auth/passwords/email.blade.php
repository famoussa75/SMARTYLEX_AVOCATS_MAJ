                    ...
                    <div class="card  text-white animated fadeIn" style="border-radius: 1rem; background:rgba(12,13,12,0.7);">
                        <div class="card-body p-2 text-center">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <h2 class="fw-bold mb-2 text-white"> <i class="fa fa-lock"></i> Reinitialisez votre mot de passe</h2>
                                <p class="text-white-50 mb-5"><i class="fa fa-info-circle"></i> Renseignez votre email puis cliquez sur <b>" Générer le lien de réinitialisation "</b>. Vous recevrez ensuite le lien par e-mail qui vous permettra de reinitialiser votre compte.</p>
                                ...
                                <form method="POST" action="{{ route('password.email')}}" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <x-input id="email" class="form-control" type="email" name="email" :value="old('email')" aria-placeholder="Email" required autofocus />
                                    </div>
                                    <div class="form-group">
                                        <div class="flex-box align-items-center">
                                            <x-button class="btn btn-block label-info">
                                    ...
                                    <div class="form-group">
                                        <div class="flex-box align-items-center">
                                            <a class="btn btn-block theme-bg" href="{{ route('login')}}">
                                               Se connecter
                                            </a>
                                        </div>
                                    </div>
