        ...
        <div class="row">
            <div class="hidden-xs hidden-sm col-lg-6 col-md-6 theme-bg">
                <div class="clearfix">
                    <div class="logo-title-container text-center" style="margin-top: -120px;">
                        ...
                        <img class="img-responsive" src="{{URL::to('/')}}/assets/dist/img/logo.png" alt="Logo Icon"
                            style="height: 300px;">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 login-ch-sideBar animated fadeInRightBig">
                ...
                <div class="login-container animated fadeInRightBig">
                    ...
                    <h2 class="text-center text-upper">Connexion</h2>
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="flex-box align-items-center">
                                ...
                                <a href="#" data-toggle="tooltip" class="theme-cl"
                        ...
                        <div class="form-group">
                            <div class="flex-box align-items-center">
                                <a type="button" href="{{route('home')}}" class="btn theme-bg">log in</a>
                                <p>If You Are a New User <a href="signup.html" data-toggle="tooltip" class="theme-cl"
                                        data-original-title="Sign Up">Signup Here.</a></p>
                            </div>
                        </div>
