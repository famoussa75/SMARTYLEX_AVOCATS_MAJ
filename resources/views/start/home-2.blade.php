<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="contact-grid-box widget advance-widget">
                <div class="widget-caption success">
                    <div class="row">
                        <div class="col-4 padd-r-0">
                            <i class="icon ti-layers-alt"></i>
                        </div>
                        <div class="col-8">
                            <div class="widget-detail">
                            @if (isset($tachePerso) && !is_null($tachePerso) && (is_array($tachePerso) || $tachePerso instanceof Countable))
                                <h3 class="infoPrive mb-2">{{count($tachePerso)}}</h3>
                            @else
                                     <h3 class="infoPrive mb-2">0</h3>
                            @endif
                                <h4>Tâches</h4>
                            </div>
                        </div>
            ...
            <div class="contact-grid-box widget advance-widget">
                <div class="widget-caption primary">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="widget-detail">
                            @if (isset($clientsPerso) && !is_null($clientsPerso) && (is_array($clientsPerso) || $clientsPerso instanceof Countable))
                                <h3 class="infoPrive mb-2">{{count($clientsPerso)}}</h3>
                            @else
                                     <h3 class="infoPrive mb-2">0</h3>
                            @endif
            ...
            <div class="contact-grid-box widget advance-widget">
                <div class="widget-caption warning">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="widget-detail">
                                @if (isset($AffairesPerso) && !is_null($AffairesPerso) && (is_array($AffairesPerso) || $AffairesPerso instanceof Countable))
                                    <h3 class="infoPrive mb-2">{{count($AffairesPerso)}}</h3>
                                @else
                                         <h3 class="infoPrive mb-2">0</h3>
                                @endif
