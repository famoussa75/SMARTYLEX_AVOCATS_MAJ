...
<div class="container-fluid">
    ...
    <div class="row page-breadcrumbs">
        ...
        <div class="col-md-6 align-self-center">
            <h5 class="theme-cl">Courrier cabinet > <span class="label bg-info"><b><i class="fa fa-envelope"></i> Courriers - Départ</b></span></h5>
        </div>
        @else
        <div class="col-md-6 align-self-center">
            <h5 class="theme-cl">
            <a class="" href="{{route('clientInfos', [$clientAffaire[0]->idClient,$clientAffaire[0]->slugClient])}}">{{ $clientAffaire[0]->idClient }} > {{ $clientAffaire[0]->prenom }} {{ $clientAffaire[0]->nom }}{{ $clientAffaire[0]->denomination }} </a> > <a class="" href="{{ route('showAffaire', [$clientAffaire[0]->idAffaire,$clientAffaire[0]->slugAffaire]) }}">{{ $clientAffaire[0]->idAffaire }} {{ $clientAffaire[0]->nomAffaire }} </a> > <span class="label bg-info"><b><i class="fa fa-envelope"></i> Courriers - Départ</b></span></h5>
        </div>
        ...
        <div class="col-md-6 text-right">
            ...
            <div class="btn-group">
                <a href="{{ route('listCourierDepart') }}" class="cl-white theme-bg btn  btn-rounded"
                    title="Afficher la liste des couriers">
                    <i class="fa fa-navicon"></i> Liste des couriers
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
            ...
            <ul class="timeline timeline">
                ...
                <li class="time-label">
                    <span class="bg-danger">
                        ...
                        Destinataire : {{ $courier->destinataire }}
                        @endforeach
                    </span>
                </li>
                <!-- END timeline item -->
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                            ...
                                            <tr>
                                                <td>Client </td>
                                                <td>{{ $clientAffaire[0]->prenom }}
                                                    {{ $clientAffaire[0]->nom }}{{ $clientAffaire[0]->denomination }}</td>
                                            </tr>
                                            <tr>
                                                <td>Affaire </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Expéditeur</td>
                                                <td> <span class=" label bg-warning">{{ $courier->expediteur }}</span> </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>Personne en charge de l'envoi</td>
                                                <td> {{ $courier->nomPersonne }}  {{ $courier->telephonePersonne }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>N° RG </td>
                                                <td> {{ $courier->numeroRecu }}</td>
                                            </tr>
                                            <tr>
                                                <td>Statut</td>

                                                @if($courier->statut=='Terminé')
                                                <td>Terminé</td>
                                                @else
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        <a href="{{ route('offConfDepart',$courier->slug) }}"
                                                    ...
                                                    @else
                                                    <div class="btn-group">
                                                        <a href="{{ route('onConfDepart',$courier->slug) }}"
        ...
        <div class="card col-md-4">
            ...
            <ul class="timeline timeline">
                ...
                <li>
                    <div class="timeline-item">
                        <h3 class="timeline-header">Accusé reception</h3>
                        <div class="timeline-body">
                                      ...
                                      @if(!empty($accuser))
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <a class="load" href="{{ route('readFile', [$accuser[0]->slug])}}"
                                                    style="color:red" class="toggle"
                                                    title="Cliquer pour afficher le contenu du fichier">Ouvrir</a> 
                                             </td>
                                        </tr>
                                        @else
                                        <tr>
                                            <td><p><i class="fa fa-envelope"></i> Par voie électronique</p></td>
                                        </tr>
                                        @endif
