...
<div class="container-fluid">
    ...
    <div class="row page-breadcrumbs">
        <div class="col-md-5 align-self-center">
            <h4 class="theme-cl">Envoi de courrier</h4>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="stepwizard">
                                    <div class="stepwizard-row setup-panel">
                                        ...
                                        <div class="form-wizard-setup">
                                            <a href="#step-3" class="btn  circle-button  active-wizard"><i class="fa fa-paper-plane-o"></i></a>
                                            <p>Procédure envoi</p>
                                        </div>
                                        <div class="form-wizard-setup last">
                                            <a href="#step-4" class="btn  circle-button disabled"><i class="fa fa-check-square-o"></i></a>
                                                ...
                                                <div class="card">
                                                    <div class="detail-wrapper padd-top-30">
                                                        ...
                                                        <div class="row  mrg-0 detail-invoice">
                                                            <div class="col-md-12">
                                                                <h2 style="text-decoration: underline;"> Courriers - Départ
                                                                </h2>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        ...
                                                                        <h4>Destinataire : {{ $courier->destinataire }}
                                                                        </h4>
                                                                        <p>
                                                                            Objet du courrier : {{ $courier->objet }}
                                                                            <br>
                                                                            Date du courrier :
