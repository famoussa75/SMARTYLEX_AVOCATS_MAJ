...
<div class="container-fluid">
    ...
    <div class="row page-breadcrumbs">
        <div class="col-md-5 align-self-center">
            <h4 class="theme-cl"><i class="fa fa-users"></i> Mes clients</h4>
        </div>

        <div class="col-md-7 text-right">
            <div class="btn-group mr-lg-2">
                <a class="load" href="{{ route('clientListeCollab') }}" class="btn  tooltips">
                    <i class="ti-flix ti-view-list-alt"></i>
                </a>
            </div>
            <div class="btn-group">
                <a  href="{{ route('clientForme') }}" class="cl-white theme-bg btn btn-rounded" title="Ajouter clients">
                    <i class="ti-wand"></i> Ajouter un client
                </a>
            </div>
        </div>
    </div>
