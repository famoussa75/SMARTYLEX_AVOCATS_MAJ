...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
                <form id="myForm" class="padd-20" method="post" action="{{ route('storeFacture') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mrg-0">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="required">Type de facture :</label>
                                <select class="form-control select2" style="width: 100%;" name="typeFacture" id="typeFacture" required>
                    ...
                    <div class="row mrg-0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if(count($affaire)==1)
                                <select class="form-control select2" style="width: 100%;" name="idAffaire" id="affaireClient" required>
                                    <option value="" selected disabled>-- Choisissez --</option>
                        ...
                        <div class="col-md-4" id="">
                            <div class="form-group">
                                <label class="required">Monnaie :</label>
                                <select class="form-control select2" style="width: 100%;" name="monnaie" id="selectMonnaie" required>
                                    <option value="" selected disabled>-- Choisissez --</option>
                        ...
                        <div class="col-md-12">
                            <label for="type" class="control-label required">Inserez des lignes</label>
                            <table class="table table-bordered" id="dynamicAddRemove">
                                ...
                                <tr>
                                    <td><input type="text" name="formset[0][designation]" placeholder="" class="form-control" required /></td>
                                    <td>
                                        <input type="number" oninput="formatNumber()" id="numberInput" min="1" name="formset[0][prix]" placeholder="" class="form-control prix" required />
                                        <span id="formattedNumber" style="margin-top: 20px; font-weight: bold;text-align:right"></span>
                                    </td>
                                    <td><button type="button" name="add" id="dynamic-ar" class="cl-white theme-bg btn btn-outline-default"><i class="fa fa-plus"></i></button></td>
                                </tr>
                            </table>
                            ...
                            <div class="row mt-5">
                                <div class="col-md-8 row">
                                    <div class="form-group col-md-4">
                                        <label for="inputPName" class="control-label required">Date facture :</label>
                                        <input type="date" name="dateFacture" id="" class="form-control" required>
                                        <div class="help-block with-errors"></div>
                                    </div> 
                                    <div class="form-group col-md-4">
                                        <label for="inputPName" class="control-label required">Date d'écheance :</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p style="text-align:right"><b>TVA (<span class="monnaieSpan"></span>) :</b> 
                                        <input type="number" step=2 min="1" name="montantTVA" id="montantTVA" readonly required>
                                    </p>
