            ...
            <div class="card">
                ...
                <form class="padd-20" id="clientPhysique" method="post" action="{{ route('addClient') }}"
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPrenom" placeholder="" name="prenom" required>
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputEmail" class="control-label required">Email de contact</label>
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputadresse" placeholder="" name="adresse" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row mrg-0">
                        <table class="table table-bordered" id="dynamicAddRemove-person">
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="formset[0][prenom]" placeholder="" class="form-control"/>
                                </td>
                                <td><input type="text" name="formset[0][nom]" placeholder="" class="form-control" /></td>
                                <td><input type="text" name="formset[0][poste]" placeholder="" class="form-control" /></td>
                                <td><input type="text" name="formset[0][email]" placeholder="" class="form-control" /></td>
                                <td><input type="text" name="formset[0][telephone]" placeholder="" class="form-control" /></td>
                                <td><button type="button" name="add" id="dynamic-clt-person" class="cl-white theme-bg btn btn-outline-default">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="text-center">
                                <button type="submit" class="theme-bg btn btn-rounded btn-block" onclick="fechAClientExist2();">
                                    <i class="fa fa-save"></i> Enregistrer</button>
                            </div>
                        </div>
                    </div>
                    <div class="add-popup modal fade" id="confirmClient2" tabindex="-1" role="dialog" aria-labelledby="confirmClient2">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color:gray;">
                                    <ul class="card-actions icons right-top">
                                        <li>
                                            <a href="javascript:void(0)" class="text-white" id="close" data-dismiss="modal" aria-label="Close">
                                                <i class="ti-close"></i>
                                            </a>
                                        </li>
                                    </ul>
                                    <h4 class="modal-title"><i class="fa fa-exclamation-triangle"></i> Confirmez l'enregistrement</h4>
                                </div>
                                <div class="modal-body">
                                    <h5 class="header-title m-t-0" style="text-align:left ;">Attention !</h5>
                                    <p>Un client de même nom ou de nom ressemblant existe déjà. Voulez-vous vraiment continuer ?</p>
                                    <div class="row mrg-0">
                                        <div class="col-md-12 col-sm-12">
                                            <a href="javascript:void(0)" class="btn btn-default" data-dismiss="modal" aria-label="Close">NON</a>
                ...
                <form class="card padd-20" id="clientMoral" method="post" action="{{ route('addClient') }}"
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="denomination" id="inputDenomination" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputEmailR" class="control-label required">Capital social</label>
                    ...
                    <div class="row mrg-0">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="inputAd" class="control-label required">Téléphone</label><br>
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="prenomRepresentant" id="inputEmailR" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputEs" class="control-label required">Nom</label>
                    ...
                    <div class="row mrg-0">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputM" class="control-label required">Email</label>
                                <input type="email" class="form-control" name="emailRepresentant" id="inputM"
                                    placeholder="" data-error="cette adresse email est invalid" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputA" class="control-label required">Téléphone</label><br>
                    ...
                    <div class="row mrg-0">
                        <table class="table table-bordered" id="dynamicAddRemove-society">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="formset[0][email]" placeholder="" class="form-control" /></td>
                                <td><input type="text" name="formset[0][telephone]" placeholder="" class="form-control" /></td>
                                <td><button type="button" name="add" id="dynamic-clt-society" class="cl-white theme-bg btn btn-outline-default"><i class="fa fa-plus"></i></button></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <div class="text-center">
                                <button type="submit" class="theme-bg btn btn-rounded btn-block" onclick="fechAClientExist();">
                                    <i class="fa fa-save"></i> Enregistrer</button>
                            </div>
                        </div>
                    </div>
                    <div class="add-popup modal fade" id="confirmClient" tabindex="-1" role="dialog" aria-labelledby="confirmClient">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color:gray;">
                                    <ul class="card-actions icons right-top">
                                ...
                                <div class="modal-body">
                                    <h5 class="header-title m-t-0" style="text-align:left ;">Attention !</h5>
                                    <p>Un client de même dénomination ou de dénomination ressemblante existe déjà. Voulez-vous vraiment continuer ?</p>
                                    <div class="row mrg-0">
                                        <div class="col-md-12 col-sm-12">
                                            <a href="javascript:void(0)" class="btn btn-default" data-dismiss="modal" aria-label="Close">NON</a>
                                            <button type="submit" class="btn btn-primary">OUI</button>
