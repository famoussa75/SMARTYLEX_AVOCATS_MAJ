...
<div class="page-header-custom d-flex flex-wrap align-items-center justify-content-between mb-4 p-3 shadow-sm bg-white rounded-3">
    ...
    <div class="d-flex align-items-center mb-2 mb-md-0">
        ...
        <div class="ms-2">
            ...
            <small class="page-description text-secondary">
                Gérez les avocats externes et leurs informations dans le système.
            </small>
        </div>
    </div>
    ...
    <div class="d-flex align-items-center">
        <a href="#" class="btn btn-gradient-custom shadow-sm" data-toggle="modal" data-target="#addavocats" title="Ajouter un avocat">
            <i class="fa fa-plus me-1"></i> Ajouter un avocat
        </a>
    </div>
