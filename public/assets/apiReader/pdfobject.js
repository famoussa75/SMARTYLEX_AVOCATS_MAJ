...
(function (root, factory) {
    ...
    */
    ...
    let embed = function(url, targetSelector, options){
        ...
        let fallbackHTML = "";
        let pdfOpenFragment = "";
        let fallbackHTML_default = "<p>Ce navigateur ne prend pas en charge les PDF en ligne. Veuillez télécharger le PDF pour le visualiser: <a href='[url]'>Télécharger le document</a></p>";

        //Ensure URL is available. If not, exit now.
        if(typeof url !== "string"){ return embedError("URL non valide", suppressConsole); }
        ...
        return embedError("Ce navigateur ne prend pas en charge les PDF intégrés", suppressConsole);
