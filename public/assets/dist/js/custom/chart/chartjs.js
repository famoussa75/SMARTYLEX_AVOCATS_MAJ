$(function () {
	...
	new Chart(document.getElementById("bar-chart"), {
		type: 'bar',
		data: {
		  labels: ["Aly", "Mariam", "Moustapha", "Aliou", "Aminata"],
		  datasets: [
			{
		...
		options: {
		  ...
		  title: {
			display: true,
			text: '5 meilleures Employés du mois'
		  }
		}
	});
	...
	new Chart(document.getElementById("pie-chart"), {
		type: 'pie',
		data: {
		  labels: ["Divorce", "Agression", "Harcelement", "Vole"],
		  datasets: [{
			label: "Nombre de cas",
		...
		options: {
		  title: {
			display: true,
			text: 'Les cas les plus frequents chez ASK AVOCATS'
		  }
		}
	});
