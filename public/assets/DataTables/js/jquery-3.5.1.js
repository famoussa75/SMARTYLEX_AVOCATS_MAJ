...
(function (global, factory) {
    ...
    (function () {
        ...
        // the select element.
        div.innerHTML = " <option value="" selected disabled>-- Choisissez --</option>";
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        for (prop in orig) {
            ...
            if (!propTween) {
                ...
                // Afficher elements before animating them
                if (hidden) {
                    showHide([elem], true);
                }
    ...
    jQuery.fn.extend({
        fadeTo: function (speed, to, easing, callback) {
            // Afficher any hidden elements after setting opacity to 0
            return (
