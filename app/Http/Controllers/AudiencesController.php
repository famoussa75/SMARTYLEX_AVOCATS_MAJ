...
class AudiencesController extends Controller
{
    ...
    public function sendMail(Request $request)
    {
        ...
        try {
            ...
            $apiKey = '2FcCv1KeouBaekvCaKgZ60oVrScsx60I'; // Remplacez par votre clé API EmailListVerify
            ...
            if ($request->has('emails') && is_array($request->input('emails'))) {
                foreach ($request->input('emails') as $email) {
                    ...
                    if (!empty($email)) {
                        ...
                        $apiKey = '2FcCv1KeouBaekvCaKgZ60oVrScsx60I'; // Remplacez par votre clé API
                    ...
                    */
                    ...
                    if (isset($request->formset)) {
                            ...
                            if ($request->file('pieceREQ') != null) {
                                ...
                                $pathSuitvitDesktop = 'assets/upload/fichiers/ordonnances/';
                                $pathSuitvit = 'assets/upload/fichiers/ordonnances/' . $filename;

                                // Vérifie si le dossier "ordonnances" existe, sinon le créer
                                if (!file_exists($pathSuitvitDesktop)) {
                                    mkdir($pathSuitvitDesktop, 0755, true);
                                }
    ...
    public function editAudienceInfo(Request $request)
    {

        $slug = $request->slug;
        $id = $request->idAudience;
        ...
        if ($request) {
            ...
            DB::update("update acte_introductifs set typeActe=? where idActe=?",[$request->typeActe, $idActeSelect[0]->idActe]);
            

            // Enregistrement de l'Assignation
            if ($request->typeActe == 'Assignation') {
                $assignations = Assignations::where('idActe', $idActeSelect[0]->idActe)->first();
                // Si aucune assignation trouvée, créer une nouvelle instance
                if (!$assignations) {
                    $assignations = new Assignations();
                    $assignations->idActe = $idActeSelect[0]->idActe;
                    $assignations->slug =  $request->_token . "" . rand(1234, 3458);

                }
                $assignations->idActe = $idActeSelect[0]->idActe;
                $assignations->numRg =  $request->numRgAss;
                $assignations->idHuissier =  $request->idHuissierAss;
                ...
                $assignations->mentionParticuliere =  $request->mentionParticuliereAssign;
                ...
                // Supprimer dans les autres tables si ca existe
                Citations::where('idActe', $idActeSelect[0]->idActe)->delete();
                Requetes::where('idActe', $idActeSelect[0]->idActe)->delete();
                Oppositions::where('idActe', $idActeSelect[0]->idActe)->delete();
                PvInterrogatoires::where('idActe', $idActeSelect[0]->idActe)->delete();
                Requisitoires::where('idActe', $idActeSelect[0]->idActe)->delete();
                OrdonnanceRenvois::where('idActe', $idActeSelect[0]->idActe)->delete();
                CitationDirectes::where('idActe', $idActeSelect[0]->idActe)->delete();
                Pcpcs::where('idActe', $idActeSelect[0]->idActe)->delete();
                DeclarationAppels::where('idActe', $idActeSelect[0]->idActe)->delete();
                Contredits::where('idActe', $idActeSelect[0]->idActe)->delete();
                Pourvois::where('idActe', $idActeSelect[0]->idActe)->delete();
            ...
            if ($request->typeActe == 'Citation') {
                ...
                $pieceCitation = Citations::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$pieceCitation) {
                    $pieceCitation = new Citations();
                    $pieceCitation->idActe = $idActeSelect[0]->idActe;
                    $pieceCitation->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $pieceCitation->idActe = $idActeSelect[0]->idActe;
                $pieceCitation->dateSignification =  $request->dateSignification;
                $pieceCitation->dateCitation =  $request->dateCitation;
                $pieceCitation->dateAudience =  $request->dateAudience;
                $pieceCitation->personneCharger=  $request->personneCharger;
                $pieceCitation->numRg =  $request->numRg;
                $pieceCitation->lieuAudience =  $request->lieuAudience;
                $pieceCitation->idHuissier =  $request->idHuissier;
               // dd($pieceCitation);
                ...
                // Supprimer dans les autres tables si ca existe
                Assignations::where('idActe', $idActeSelect[0]->idActe)->delete();
                Requetes::where('idActe', $idActeSelect[0]->idActe)->delete();
                Oppositions::where('idActe', $idActeSelect[0]->idActe)->delete();
                PvInterrogatoires::where('idActe', $idActeSelect[0]->idActe)->delete();
                Requisitoires::where('idActe', $idActeSelect[0]->idActe)->delete();
            ...
            if ($request->typeActe == 'Requete') {
                ...
                $requetes = Requetes::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$requetes) {
                    $requetes = new Requetes();
                    $requetes->idActe = $idActeSelect[0]->idActe;
                    $requetes->slug =  $request->_token . "" . rand(1234, 3458);
            ...
            if ($request->typeActe == 'Opposition') {
                ...
                $oppositions = Oppositions::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$oppositions) {
                    $oppositions = new Oppositions();
                    $oppositions->idActe = $idActeSelect[0]->idActe;
                    $oppositions->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $oppositions->idActe = $idActeSelect[0]->idActe;
                $oppositions->idHuissier =  $request->idHuissier;
                $oppositions->dateActe =  $request->dateActe;
                $oppositions->dateProchaineAud =  $request->dateProchaineAud;
                $oppositions->numDecision =  $request->numDecision;
                $oppositions->numRg =  $request->numRg;
                $oppositions->recepteurAss =  $request->recepteurOpp;
                $oppositions->datePremiereComp =  $request->datePremiereCompOpp;
                $oppositions->dateEnrollement =  $request->dateEnrollementOpp;
                $oppositions->mentionParticuliere=  $request->mentionParticuliere;                
                $oppositions->save();
            ...
            if ($request->typeActe == 'PV introgatoire') {
                ...
                $pvInterrogatoires = PvInterrogatoires::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$pvInterrogatoires) {
                    $pvInterrogatoires = new PvInterrogatoires();
                    $pvInterrogatoires->idActe = $idActeSelect[0]->idActe;
                    $pvInterrogatoires->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $pvInterrogatoires->idActe = $idActeSelect[0]->idActe;
            ...
            if ($request->typeActe == 'Requisitoire') {
                ...
                $requisitoires = Requisitoires::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$requisitoires) {
                    $requisitoires = new Requisitoires();
                    $requisitoires->idActe = $idActeSelect[0]->idActe;
                    $requisitoires->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $requisitoires->idActe = $idActeSelect[0]->idActe;
            ...
            if ($request->typeActe == 'Ordonnance Renvoi') {
                ...
                $ordonnanceRenvois = OrdonnanceRenvois::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$ordonnanceRenvois) {
                    $ordonnanceRenvois = new OrdonnanceRenvois();
                    $ordonnanceRenvois->idActe = $idActeSelect[0]->idActe;
                    $ordonnanceRenvois->slug =  $request->_token . "" . rand(1234, 3458);
            ...
            if ($request->typeActe == 'Citation directe') {
                ...
                $citationDirectes = CitationDirectes::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$citationDirectes) {
                    $citationDirectes = new CitationDirectes();
                    $citationDirectes->idActe = $idActeSelect[0]->idActe;
                    $citationDirectes->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $citationDirectes->idActe = $idActeSelect[0]->idActe;
            ...
            if ($request->typeActe == 'PCPC') {
                ...
                $pcpcs = Pcpcs::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$pcpcs) {
                    $pcpcs = new Pcpcs();
                    $pcpcs->idActe = $idActeSelect[0]->idActe;
                    $pcpcs->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $pcpcs->idActe = $idActeSelect[0]->idActe;
            ...
            if ($request->typeActe == "Declaration d'appel") {
                ...
                $declarationAppels = DeclarationAppels::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$declarationAppels) {
                    $declarationAppels = new DeclarationAppels();
                    $declarationAppels->idActe = $idActeSelect[0]->idActe;
                    $declarationAppels->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $declarationAppels->idActe = $idActeSelect[0]->idActe;
            ...
            if ($request->typeActe == "Contredit") {
                ...
                $contredits = Contredits::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$contredits) {
                    $contredits = new Contredits();
                    $contredits->idActe = $idActeSelect[0]->idActe;
                    $contredits->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $contredits->idActe = $idActeSelect[0]->idActe;
            ...
            if ($request->typeActe == "Pourvoi") {
                ...
                $pourvois = Pourvois::where('idActe', $idActeSelect[0]->idActe)->first();
                if (!$pourvois) {
                    $pourvois = new Pourvois();
                    $pourvois->idActe = $idActeSelect[0]->idActe;
                    $pourvois->slug =  $request->_token . "" . rand(1234, 3458);
                }
                $pourvois->idActe = $idActeSelect[0]->idActe;
        ...
        return redirect()->route('detailAudience', [
            'slug' => $slug,
            'id'   => $id,
            'niveau'=> $request->niveauProcedural,
        ])->with('success', 'Audience modifiée avec succès');
    ...
    public function pubUpdate($slug, $id)
    {
     ...
     ", [$id, $id, $id]); // Sécurisation avec les paramètres liés
         ...
         if (!empty($actes) && $actes[0]->typeActe=='Citation') {
            $acteDetail = DB::select("select * from citations,huissiers where citations.idHuissier=huissiers.idHss and idActe=?",[$actes[0]->idActe]);
            //dd($acteDetail);
         }
    ...
    public function suiviAudienceAppel(Request $request)
    {
        ...
        if ($request) {
            ...
            if ($request->acte == "Délibéré prorogé") {
                ...
                $suivi->idAudience = $request->idAudience;
                $suivi->acte = $request->acte;
                $suivi->dateActe = $request->dateActeProrogé; 
                $suivi->dateReception = 'N/A';
    ...
    public function terminerRequete($slug)
    {
    ...
    public function fetchRequete($id)
    {
        // Verication du typeContent pour retourner une bonne reponse
