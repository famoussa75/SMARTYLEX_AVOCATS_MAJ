...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // JOIN clients ON parties.idClient = clients.idClient JOIN affaires ON parties.idAffaire = affaires.idAffaire WHERE notifications.etat = 'masquer' AND audiences.niveauProcedural ='1ère instance' AND  notifications.idRecepteur = 'admin' AND notifications.idAdmin = ?
