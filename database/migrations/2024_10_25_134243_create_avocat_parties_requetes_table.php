...
class CreateAvocatPartiesRequetesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('avocat_parties_requetes', function (Blueprint $table) {
            $table->charset = 'utf8';
    ...
    {
        Schema::dropIfExists('avocat_parties_requetes');
    }
}
